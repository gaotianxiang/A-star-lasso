...
from a_star_lasso import a_star_lasso
...
def wrap_astar_lasso(net_id, num_samples, lower_bd, upper_bd, lambda_, set_):
    ...
    solution, _ = a_star_lasso(y_train, lambda_)
    ...
    out_filename = '{}_astarlasso_n{}_lb{}_ub{}_lambda{}_set{}'.format(name, num_samples, lower_bd * 10, upper_bd * 10,
                                                                       lambda_, set_)
